...
window.AFYA_AVATARS = [
  ...
  { id: 'adv_04', name: 'Kenji', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Kenji&backgroundColor=b6e3f4' },
  { id: 'adv_05', name: 'Amara', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Amara&backgroundColor=d1d4f9' },
  { id: 'adv_06', name: 'Felix', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Felix&backgroundColor=c0aede' },
  { id: 'adv_07', name: 'Sienna', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Sienna&backgroundColor=ffd5dc' },
  { id: 'adv_08', name: 'Diego', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Diego&backgroundColor=ffdfbf' },
  { id: 'adv_09', name: 'Layla', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Layla&backgroundColor=b6e3f4' },
  { id: 'adv_10', name: 'Hiroshi', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Hiroshi&backgroundColor=c0e8f9' },
  { id: 'adv_11', name: 'Nia', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Nia&backgroundColor=d1d4f9' },
  { id: 'adv_12', name: 'Oscar', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Oscar&backgroundColor=c0aede' },
  { id: 'adv_13', name: 'Priya', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Priya&backgroundColor=ffd5dc' },
  { id: 'adv_14', name: 'Yuki', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Yuki&backgroundColor=ffdfbf' },
  { id: 'adv_15', name: 'Theo', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Theo&backgroundColor=b6e3f4' },
  { id: 'adv_16', name: 'Lucas', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Lucas&backgroundColor=c0e8f9' },
  { id: 'adv_17', name: 'Mateo', category: 'adventurer', url: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Mateo&backgroundColor=ffdfbf' },
  ...
  { id: 'lor_04', name: 'Liam', category: 'lorelei', url: 'https://api.dicebear.com/7.x/lorelei/svg?seed=Liam&backgroundColor=d1fae5' },
  { id: 'lor_05', name: 'Mia', category: 'lorelei', url: 'https://api.dicebear.com/7.x/lorelei/svg?seed=Mia&backgroundColor=fef3c7' },
  { id: 'lor_06', name: 'Ethan', category: 'lorelei', url: 'https://api.dicebear.com/7.x/lorelei/svg?seed=Ethan&backgroundColor=dbeafe' },
  { id: 'lor_07', name: 'Isabella', category: 'lorelei', url: 'https://api.dicebear.com/7.x/lorelei/svg?seed=Isabella&backgroundColor=fce7f3' },
  { id: 'lor_08', name: 'Noah', category: 'lorelei', url: 'https://api.dicebear.com/7.x/lorelei/svg?seed=Noah&backgroundColor=d1fae5' },
  ...
  { id: 'smile_04', name: 'Luna', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Luna&backgroundColor=d1fae5' },
  { id: 'smile_05', name: 'Leo', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Leo&backgroundColor=fed7aa' },
  { id: 'smile_06', name: 'Stella', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Stella&backgroundColor=ede9fe' },
  { id: 'smile_07', name: 'Rio', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Rio&backgroundColor=fecaca' },
  { id: 'smile_08', name: 'Pixie', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Pixie&backgroundColor=fef3c7' },
  { id: 'smile_09', name: 'Charlie', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Charlie&backgroundColor=dbeafe' },
  { id: 'smile_10', name: 'Coco', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Coco&backgroundColor=fce7f3' },
  { id: 'smile_11', name: 'Toby', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Toby&backgroundColor=dbeafe' },
  { id: 'smile_12', name: 'Finn', category: 'bigsmile', url: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Finn&backgroundColor=fed7aa' },
  ...
  { id: 'bot_04', name: 'Echo', category: 'bottts', url: 'https://api.dicebear.com/7.x/bottts/svg?seed=Echo&backgroundColor=581c87' },
  { id: 'bot_05', name: 'Cypher', category: 'bottts', url: 'https://api.dicebear.com/7.x/bottts/svg?seed=Cypher&backgroundColor=831843' },
  { id: 'bot_06', name: 'Nova', category: 'bottts', url: 'https://api.dicebear.com/7.x/bottts/svg?seed=Nova&backgroundColor=92400e' },
  { id: 'bot_07', name: 'Buzz', category: 'bottts', url: 'https://api.dicebear.com/7.x/bottts/svg?seed=Buzz&backgroundColor=14532d' },
  { id: 'bot_08', name: 'Volt', category: 'bottts', url: 'https://api.dicebear.com/7.x/bottts/svg?seed=Volt&backgroundColor=1e40af' },
  ...
  { id: 'shape_04', name: 'Sunset', category: 'shapes', url: 'https://api.dicebear.com/7.x/shapes/svg?seed=Sunset' },
  { id: 'shape_05', name: 'Cosmos', category: 'shapes', url: 'https://api.dicebear.com/7.x/shapes/svg?seed=Cosmos' }
];

window.getAvatarById = function(id) {
  return window.AFYA_AVATARS.find(a => a.id === id);
};

window.getAvatarUrl = function(id) {
  const avatar = window.getAvatarById(id);
